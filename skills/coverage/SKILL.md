...
`audit`'s `test-coverage` playbook (`skills/audit/assets/templates/methodology/test-coverage.md.template`).
...
(`reference/references/03-shaping.md` is the canon; this is its application):
