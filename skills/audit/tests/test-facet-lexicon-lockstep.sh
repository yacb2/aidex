#!/usr/bin/env bash
# Facet-lexicon lockstep guard for audit's usage-retro (plan usage-retro-facets,
# phase 3).
#
...
# or a facet name (workflow/tests/test-shape-enum-lockstep.sh's rule).
...
#
# Run with: bash skills/audit/tests/test-facet-lexicon-lockstep.sh
