...
```bash
R=${CLAUDE_PLUGIN_ROOT}/skills/audit/scripts/usage-retro       # or <repo>/skills/audit/scripts/usage-retro
RUN=.context/audits/usage-retro/$(date +%F)-usage-retro
CUR=.context/audits/.usage-retro/cursor.json

bash ${CLAUDE_PLUGIN_ROOT}/skills/audit/scripts/new-audit.sh custom usage-retro   # scaffold the run
...
Validate with `skills/audit/scripts/validate-audit.sh`.
