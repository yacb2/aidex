...
#
# Run:  bash skills/conventions/scripts/test_workflow_core_drift.sh
...
echo ""
echo "drift-lock: $PASS ok, $FAIL drifted (canonical: skills/conventions/references/workflow-core.md)"
[ "$FAIL" -eq 0 ]
