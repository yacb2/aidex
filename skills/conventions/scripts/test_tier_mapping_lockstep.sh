...
# §Optional phase metadata, plan-exec's 01-unattended-batch-execution.md
...
#
# Not to be confused with workflow's stage heuristic
...
CANON="$REPO/skills/conventions/references/plan-conventions.md"
BATCH="$REPO/skills/plan-exec/references/01-unattended-batch-execution.md"
TIERING="$REPO/skills/plan-exec/references/04-model-tiering.md"
WORKFLOWS="$REPO/skills/plan-exec/assets/workflows"
