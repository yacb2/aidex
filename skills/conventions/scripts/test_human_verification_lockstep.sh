...
#
# Run with: bash skills/conventions/scripts/test_human_verification_lockstep.sh

set -uo pipefail

SKILLS="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd -P)"
CANON="${CANON_OVERRIDE:-$SKILLS/conventions/references/human-verification-conventions.md}"
