...
Run with: python3 skills/conventions/scripts/test_fleet_version_lockstep.py
...
SKILL_DIR = os.path.join(REPO, "skills", "conventions")
...
if CANON_NAME not in read(SKILL_MD):
    fail("conventions/SKILL.md does not list %s — an unregistered canon is unfindable" % CANON_NAME)
