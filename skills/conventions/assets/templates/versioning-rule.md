...
<!--
  ...
  `${CLAUDE_PLUGIN_ROOT}/skills/conventions/references/fleet-version-conventions.md`,
...
Procedure: `${CLAUDE_PLUGIN_ROOT}/skills/conventions/references/fleet-version-conventions.md`
