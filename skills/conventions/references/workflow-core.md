...
4. Run the drift-lock: `bash skills/conventions/scripts/test_workflow_core_drift.sh` (it
   checks both the CORE and ARBITER blocks).
5. Run the behaviour guard: `bash skills/conventions/scripts/test_workflow_core_publication.sh`.
