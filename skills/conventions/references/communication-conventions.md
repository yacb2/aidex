...
participants:           # replaces from/to — the people in the conversation
  - "Marta Ruiz <marta@ejemplo.com> (Ejemplo SL)"
  - "Diego Ferrer <diego@ejemplo.com> (Ejemplo SL)"
organizer: "Marta Ruiz"   # optional — who convened it
...
```bash
bash ${CLAUDE_PLUGIN_ROOT}/skills/comm/scripts/migrate-communications.sh
```
