...
The shared canon (`conventions/references/reference-conventions.md`, § Stable anchors) bans bare line numbers; this module does not fork that rule. One project's architecture
...
```bash
cd <project> && ${CLAUDE_PLUGIN_ROOT}/skills/reference/scripts/docs-census.sh --advisory
```
