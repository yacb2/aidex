...
> (`conventions/references/reference-conventions.md`) and are not forked here. This file
...
```bash
wc -w ${CLAUDE_PLUGIN_ROOT}/skills/reference/references/*.md ${CLAUDE_PLUGIN_ROOT}/skills/reference/SKILL.md
```
