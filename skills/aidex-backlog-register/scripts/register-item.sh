...
# --- dispatcher: strip leading "aidex-backlog-register" if present ---
if [[ "${1:-}" == "aidex-backlog-register" ]]; then shift; fi
...
regen_index() {
  ...
  {
    printf '# Backlog\n\n'
    printf '_Auto-generated by `aidex-backlog-register` from front-matter. Do not edit by hand._\n\n'
    printf '**Updated:** %s\n' "$today"
