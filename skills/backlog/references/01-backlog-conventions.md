...
> **Read [`00-global.md`](../../conventions/references/00-global.md) first.** Filename dates, archive, language, cross-references, and minimum front-matter live there. This file only declares what is specific to the backlog (priority taxonomy, `00-index.md` auto-regeneration, body shape).
...
The backlog index is **generated by `backlog` from front-matter** — never hand-edit it. Running `backlog --reindex` (or any `backlog` write) regenerates it.
...
_Auto-generated by `backlog` from front-matter. Do not edit by hand._
...
global fields from [`00-global.md` §7](../../conventions/references/00-global.md#7-front-matter-minimum-d-07);
...
regression-test-first procedure (`bugfix`), because the front-matter field is a
...
- **Hand-editing `00-index.md`** — your edit will be erased on the next `backlog --reindex`.
...
- [`00-global.md`](../../conventions/references/00-global.md) — shared rules.
- [`audit-conventions.md`](../../conventions/references/audit-conventions.md) — how findings become backlog entries.
- [`plan-conventions.md`](../../conventions/references/plan-conventions.md) — how backlog entries promote to plans.
