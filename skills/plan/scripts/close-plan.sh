...
#
# After closing, run `backlog/scripts/reconcile.sh` (Phase 6) to surface upstream backlog/findings
...
AUDIT_SCRIPTS="$(dirname "${BASH_SOURCE[0]}")/../../audit/scripts"
...
SWEEP="$(dirname "${BASH_SOURCE[0]}")/../../backlog/scripts/sweep.sh"
if [[ -x "$SWEEP" ]]; then
