---
name: aidex
description: Audits and fixes the Claude Code ecosystem — skills, .context/ structure, symlinks, MEMORY.md, CLAUDE.md, plugins, and idle context budget. Triggers on /aidex, /aidex context, and on natural-language asks like — "audit my project" / "check my project's health" / "is my setup clean?" / "review the ecosystem" / "my project is messy" / "everything is disorganized" / "clean up MEMORY.md" / "MEMORY.md is bloated" / "find broken symlinks" / "I have dangling symlinks" / "stale documentation" / "docs are outdated" / "list installed skills" / "what skills do I have?" / "inventory my skills" / "verify CLAUDE.md links" / "reorganize .context/" / "this project opens heavy" / "wastes too much context" / "reduce initial token cost" / "shrink my idle context" / "audit installed plugins" / "this skill doesn't apply to this stack" / "optimize my Claude Code setup" / "organize my ecosystem". Also auto-activates when Claude notices a broken symlink while reading .claude/skills/, MEMORY.md exceeds ~80 lines, or a referenced file in a skill is missing. Do NOT use for: creating documentation (plans, decisions, requests, references, research) → use aidex-conventions; running a project-state audit (UX, security, perf, a11y) → use audit; backlog entries → use backlog-register.
