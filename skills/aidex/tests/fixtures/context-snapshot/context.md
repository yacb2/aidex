...
| Type | Path | Tokens |
|------|------|--------|
| User | /Users/user/.claude/CLAUDE.md | 2.4k |
| User | /Users/user/.claude/rules/database-protection.md | 1.4k |
| User | /Users/user/.claude/rules/e2e-testing.md | 818 |
| User | /Users/user/.claude/rules/artifacts-local-first.md | 1.5k |
| User | /Users/user/.claude/rules/aidex-conventions.md | 3k |
| User | /Users/user/.claude/rules/verification-before-claims.md | 748 |
| User | /Users/user/.claude/rules/memory-hygiene.md | 1.5k |
| User | /Users/user/.claude/rules/root-cause-first.md | 139 |
| User | /Users/user/.claude/rules/autonomy.md | 2.1k |
| User | /Users/user/.claude/rules/harness-lessons.md | 844 |
| Project | /Users/user/Documents/projects/aidex/CLAUDE.md | 2.5k |
| AutoMem | /Users/user/.claude/projects/-Users-user-Documents-projects-aidex/memory/MEMORY.md | 1.2k |
