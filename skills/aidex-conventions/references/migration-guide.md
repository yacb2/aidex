...
~/.claude/skills/aidex-conventions/scripts/migrate-conventions.sh /path/to/project/.context

# Apply when satisfied:
~/.claude/skills/aidex-conventions/scripts/migrate-conventions.sh /path/to/project/.context --apply
```
...
~/.claude/skills/aidex-conventions/scripts/backfill-indexes.sh

# Every project under a root (creates only MISSING indexes; skips hand-made ones):
~/.claude/skills/aidex-conventions/scripts/backfill-indexes.sh --all ~/Documents/projects --dry-run
~/.claude/skills/aidex-conventions/scripts/backfill-indexes.sh --all ~/Documents/projects
```
