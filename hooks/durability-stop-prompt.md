...
Key fields: last_assistant_message, stop_hook_active, cwd, transcript_path. You may read transcript_path and inspect cwd to understand whether an autonomous multi-step task is in flight. Judge from the actual situation, never from specific wording.
